<template>
  <div class="editor-container" >
    ...
    <button class="save-button" @click="saveArticle">添加文章</button>
...
import { onBeforeUnmount, ref, shallowRef, onMounted, onBeforeMount, computed } from 'vue'
//@ts-ignore
...
//! TODO:这里的addarticleAPI应该和editarticleAPI合并成一个API
    const title = ref('')
    ...
    const id = ref('')
    // 内容 HTML
    const wholeURL = computed(()=>{
      return 'http://localhost:3000' + route.path
    })
